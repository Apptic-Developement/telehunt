...
export default function CaregoryGrid({ name, icon: Icon, data }: { name: string; icon: IconType, data: CardData[] }) {
    return (
        <section className="flex flex-col gap-8 w-full container mx-auto lg:px-16 md:px-10">
            <div className="flex items-center justify-between gap-2 w-full">
                <div className="flex flex-col gap-2">
                    ...
                    <p className="text-sm text-muted-foreground">Lorem ipsum dolor sit amet consectetur adipisicing elit. Porro, vero?</p>
                </div>
