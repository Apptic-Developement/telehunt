...
export const addChannelSchema = z.object({
  ...
  shortDescription: z
    .string()
    .min(5, {
      message: "Short Description must contain at least 5 character(s)",
    })
    .max(100, {
      message: "Short Description must contain at most 100 character(s)",
    }),
  longDescription: z
    .string()
    .min(50, {
      message: "Long Description must contain at least 50 character(s)",
    })
    .max(500, {
      message: "Long Description must contain at most 500 character(s)",
    }),
  tags: z
    .array(z.string())
